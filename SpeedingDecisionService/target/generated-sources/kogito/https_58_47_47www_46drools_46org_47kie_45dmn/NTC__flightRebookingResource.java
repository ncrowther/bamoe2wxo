 ...
 */
package https_58_47_47www_46drools_46org_47kie_45dmn;
...
@Path("/NTC_flightRebooking")
public class NTC__flightRebookingResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://www.drools.org/kie-dmn", "NTC_flightRebooking");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://www.drools.org/kie-dmn", "NTC_flightRebooking", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("NTC_flightRebooking") + ".dmn_nologic")));
    }
